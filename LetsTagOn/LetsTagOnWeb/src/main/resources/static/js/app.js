        ...
        function($routeProvider, $httpProvider, $locationProvider) {
            ...
            $routeProvider
                ...
                .when('/pending/connection/user/:userId', {
                    templateUrl: './js/pages/connections/pending_connection_listing.html',
                ...
                .when('/view/opportunity/:oppId', {
                    ...
                    templateUrl: './js/pages/opportunity/opportunity_listing_my_upcoming.html',
                    ...
                    templateUrl: './js/pages/opportunity/manage/opportunity_manageApplications.html',
                    controller: 'ManageOppApplicationsController',
                    controllerAs: 'controller'
                }).when('/opportunity/manageFeedback/:oppId', {
                        templateUrl: './js/pages/opportunity/manage/opportunity_manageFeedback.html',
                        controller: 'ManageOppFeedbackController',
                        controllerAs: 'controller'
                }).when('/opportunity/manageAttendance/:oppId', {
                    templateUrl: './js/pages/opportunity/manage/opportunity_manageAttendance.html',
                    controller: 'ManageOppAttendanceController',
                }).when('/view/opportunity/program/edit/:programID', {
                    templateUrl: './js/pages/opportunity/opportunity_program_event.html',
                    ...
                    templateUrl: './js/pages/notification/view_all_notifications.html',
            ...
            function($rootScope, $location, $scope) {
                $rootScope
                    .$on(
                        '$routeChangeStart',
                        function(event) {
                            if ($(".lto-pending-notification-user-dropdownList").hasClass("block")) {
                                $(".lto-pending-notification-user-dropdownList").addClass("hide");
                            }
