    ...
    .controller(
        ...
        function($http, $scope, $rootScope, $location, $timeout) {
                ...
                .success(
                    function(response) {
                        if (response.error == null &&
                            ...
                            $scope.educationDetailsList = response.data.userExperience.educationDetails;
                            $scope.professionalDetailsList = response.data.userExperience.professionalDetails;
                            $scope.volunteeringDetailsList = response.data.userExperience.volunteeringDetails;
                            $scope.userSkillsList = response.data.skills;
                            $scope.userCausesList = response.data.causes;
                            $scope.volunteerOpportunityCount = response.data.volunteerOpportunityCount;
                            $scope.volunteerConnectionCount = response.data.volunteerConnectionCount;
            ...
            $scope.applyPrivacySettings = function(privacySettings) {
                if (privacySettings != null && privacySettings != "" && typeof(privacySettings) != "undefined") {
            ...
            $scope.getProfileCompletionStatus = function() {
                $http({
                    ...
                    if (response.error == null) {
                        ...
                        var width = $scope.ProfileCompletionStatusDTO.completion * 100 + "%";
