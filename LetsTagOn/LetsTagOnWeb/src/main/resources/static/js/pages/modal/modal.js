var bootstrapModal = angular.module('bootstrapModal', ["ngLocalize", "localization"]);

bootstrapModal.controller('BootstrapModalController', function($http, $scope,
...
bootstrapModal
    .directive(
        ...
        function() {
            return {
                template: '<div class="modal" id="modal-success" ng-controller="PasswordController">' +
...
bootstrapModal
    .directive(
        ...
        function() {
            return {
                template: '<div class="modal" id="lto-modal-success">' +
...
bootstrapModal
    .directive(
        ...
        function() {
            return {
                template: '<div class="modal" id="lto-modal-error">' +
...
bootstrapModal
    .directive(
        ...
        function() {
            return {
                template: '<div class="modal" id="modal-error">' +
                    '<div class="modal-dialog registration-error-modal-dialog">' +
                    '<div class="modal-content registration-error-modal-content">' +
                    '<div class="modal-header">' +
                    '<button type="button" class="close" data-dismiss="modal">&times;</button>' +
                    '<h2 class="modal-title error">OOPS! Something went wrong</h2>' +
                    '</div>' +
...
bootstrapModal
    .directive(
        ...
        function() {
            return {
                template: '<div class="modal" id="modal-session-timeout">' +
